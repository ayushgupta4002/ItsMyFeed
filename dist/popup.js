...
(() => {
  ...
  var Gem = createLucideIcon("gem", __iconNode6);
  ...
  var Hash = createLucideIcon("hash", __iconNode7);
  ...
  function Popup() {
    const [keywords, setKeywords] = (0, import_react3.useState)("");
    const [aiEnabled, setAiEnabled] = (0, import_react3.useState)(false);
    const [aiFilter, setAiFilter] = (0, import_react3.useState)("");
    const [geminiApiKey, setGeminiApiKey] = (0, import_react3.useState)("");
    const [isApiKeyDropdownExpanded, setIsApiKeyDropdownExpanded] = (0, import_react3.useState)(false);
    const [isKeywordDropdownExpanded, setIsKeywordDropdownExpanded] = (0, import_react3.useState)(false);
    const [isAiDropdownExpanded, setIsAiDropdownExpanded] = (0, import_react3.useState)(false);
    const [isDropdownExpanded, setIsDropdownExpanded] = (0, import_react3.useState)(false);
    const [hiddenVideosData, setHiddenVideosData] = (0, import_react3.useState)({
      hiddenVideos: [],
      totalCount: 0,
      keywordCount: 0,
      aiCount: 0
    ...
    const [showStatus, setShowStatus] = (0, import_react3.useState)(false);
    const [statusMessage, setStatusMessage] = (0, import_react3.useState)("");
    const [keywordsError, setKeywordsError] = (0, import_react3.useState)("");
    const [aiFilterError, setAiFilterError] = (0, import_react3.useState)("");
    const [apiKeyError, setApiKeyError] = (0, import_react3.useState)("");
    ...
    const loadHiddenVideos = (0, import_react3.useCallback)(async () => {
    ...
    (0, import_react3.useEffect)(() => {
      ...
      if (isDropdownExpanded) {
        loadHiddenVideos();
        interval = setInterval(loadHiddenVideos, 3e3);
      }
      return () => {
    ...
    const handleSave = async () => {
      ...
      try {
        ...
        if (typeof chrome !== "undefined" && chrome.storage) {
          ...
          setShowStatus(true);
          setTimeout(() => setShowStatus(false), 3e3);
          const [tab] = await chrome.tabs.query({ active: true, currentWindow: true });
          if (tab?.url?.includes("youtube.com")) {
            chrome.tabs.sendMessage(tab.id, { type: "UPDATE_FILTERS" }, () => {
              setTimeout(loadHiddenVideos, 1e3);
            });
          }
        }
      } catch (error) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "w-full min-w-80 max-w-100 p-6 font-inter bg-black text-white leading-relaxed min-h-screen antialiased", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "text-center mb-8 pb-6 border-b border-gray-800", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-center gap-3 mb-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src: "/logo.png", alt: "ItsMyFeed Logo", className: "w-7 h-7" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "text-3xl font-bold bg-gradient-to-r from-red-500 to-red-400 bg-clip-text text-transparent", children: "ItsMyFeed" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-gray-400 font-medium", children: "Smart content filtering for YouTube" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mb-6 p-5 bg-gray-900/80 backdrop-blur-md rounded-xl border border-gray-800 transition-all duration-300 hover:border-gray-700 hover:bg-gray-900/90", children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Gem, { className: "w-5 h-5 text-red-500" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-lg font-semibold text-white tracking-tight", children: "Gemini API Key Setup" }),
                geminiApiKey.trim() && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "ml-2 px-3 py-1 bg-red-600/80 backdrop-blur-sm text-white text-xs font-medium rounded-full flex items-center gap-1", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheckBig, { className: "w-3 h-3" }),
                  "Configured"
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: `w-4 h-4 transition-transform duration-300 text-gray-400 ${isApiKeyDropdownExpanded ? "transform rotate-180" : ""}` })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `overflow-hidden transition-all duration-300 ${isApiKeyDropdownExpanded ? "max-h-96 mt-4" : "max-h-0"}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-gray-400 mb-4 leading-relaxed font-medium", children: "Enter your own Gemini API key (optional - leave blank to use shared key)" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "input",
            {
              ...
              className: `w-full p-4 bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-lg text-white text-sm font-medium transition-all duration-300 focus:outline-none focus:border-red-500 focus:shadow-lg focus:shadow-red-500/20 placeholder:text-gray-500 placeholder:font-normal ${apiKeyError ? "border-red-500" : ""}`
            }
          ),
          apiKeyError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-red-400 text-sm mt-2 font-medium", children: apiKeyError }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-3 p-3 bg-gray-800/60 backdrop-blur-sm rounded-lg border-l-4 border-red-500", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-2 text-sm font-semibold text-gray-300 mb-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Info, { className: "w-4 h-4" }),
              "About API Keys:"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "text-sm text-gray-400 leading-relaxed space-y-1 font-medium", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                "\u2022 Get your free API key from ",
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-red-400 font-semibold", children: "console.cloud.google.com" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "\u2022 Using your own key ensures better reliability and avoids rate limits" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "\u2022 Your key is stored locally and never shared" })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mb-6 p-5 bg-gray-900/80 backdrop-blur-md rounded-xl border border-gray-800 transition-all duration-300 hover:border-gray-700 hover:bg-gray-900/90", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Hash, { className: "w-5 h-5 text-red-500" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-lg font-semibold text-white tracking-tight", children: "Keyword Filtering" }),
                keywords.trim() && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "ml-2 px-3 py-1 bg-red-600/80 backdrop-blur-sm text-white text-xs font-medium rounded-full flex items-center gap-1", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheckBig, { className: "w-3 h-3" }),
                  "Active"
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: `w-4 h-4 transition-transform duration-300 text-gray-400 ${isKeywordDropdownExpanded ? "transform rotate-180" : ""}` })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `overflow-hidden transition-all duration-300 ${isKeywordDropdownExpanded ? "max-h-96 mt-4" : "max-h-0"}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-gray-400 mb-4 leading-relaxed font-medium", children: "Hide videos containing these keywords (always active)" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "textarea",
            {
              value: keywords,
              ...
              className: `w-full p-4 bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-lg text-white text-sm font-medium transition-all duration-300 resize-y min-h-24 max-h-32 focus:outline-none focus:border-red-500 focus:shadow-lg focus:shadow-red-500/20 placeholder:text-gray-500 placeholder:font-normal ${keywordsError ? "border-red-500" : ""}`
            }
          ),
          keywordsError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-red-400 text-sm mt-2 font-medium", children: keywordsError })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mb-6 p-5 bg-gray-900/80 backdrop-blur-md rounded-xl border border-gray-800 transition-all duration-300 hover:border-gray-700 hover:bg-gray-900/90", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bot, { className: "w-5 h-5 text-red-500" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-lg font-semibold text-white tracking-tight", children: "AI Smart Filtering" }),
                aiEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "ml-2 px-3 py-1 bg-red-600/80 backdrop-blur-sm text-white text-xs font-medium rounded-full flex items-center gap-1", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheckBig, { className: "w-3 h-3" }),
                  "Enabled"
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: `w-4 h-4 transition-transform duration-300 text-gray-400 ${isAiDropdownExpanded ? "transform rotate-180" : ""}` })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `overflow-hidden transition-all duration-300 ${isAiDropdownExpanded ? "max-h-96 mt-4" : "max-h-0"}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `flex items-center mb-5 p-4 bg-gray-800/60 backdrop-blur-sm rounded-lg transition-all duration-300 hover:bg-gray-800/80 ${aiEnabled ? "bg-red-500/10 border border-red-500/30" : ""}`, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative w-12 h-6 mr-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "input",
                {
                  type: "checkbox",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                ...
                {
                  htmlFor: "aiEnabled",
                  className: `absolute cursor-pointer top-0 left-0 right-0 bottom-0 rounded-full transition-all duration-300 ${aiEnabled ? "bg-gradient-to-r from-red-600 to-red-500 shadow-lg shadow-red-500/40" : "bg-gray-600"}`,
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `absolute h-4.5 w-4.5 left-0.75 bottom-0.75 bg-white rounded-full transition-all duration-300 ${aiEnabled ? "transform translate-x-6" : ""}` })
                }
              )
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "aiEnabled", className: "text-sm font-semibold text-white cursor-pointer flex-1", children: "Enable AI-powered filtering" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-gray-400 mb-4 leading-relaxed font-medium", children: "Describe what type of content you want to filter out" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "input",
            {
              type: "text",
              ...
              disabled: !aiEnabled,
              className: `w-full p-4 bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-lg text-white text-sm font-medium transition-all duration-300 focus:outline-none placeholder:text-gray-500 placeholder:font-normal ${!aiEnabled ? "opacity-50 cursor-not-allowed" : "focus:border-red-500 focus:shadow-lg focus:shadow-red-500/20"} ${aiFilterError ? "border-red-500" : ""}`
            }
          ),
          aiFilterError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-red-400 text-sm mt-2 font-medium", children: aiFilterError }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-3 p-3 bg-gray-800/60 backdrop-blur-sm rounded-lg border-l-4 border-red-500", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-2 text-sm font-semibold text-gray-300 mb-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lightbulb, { className: "w-4 h-4" }),
              "Examples:"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-gray-400 leading-relaxed font-medium", children: '"music videos" \u2022 "reaction videos" \u2022 "clickbait content" \u2022 "gaming streams" \u2022 "shorts under 1 minute"' })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mb-8 p-5 bg-gray-900/80 backdrop-blur-md rounded-xl border border-gray-800 transition-all duration-300 hover:border-gray-700 hover:bg-gray-900/90", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            className: "flex items-center justify-between cursor-pointer py-2 transition-all duration-300 hover:text-red-400",
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, { className: "w-5 h-5 text-red-500" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-lg font-semibold text-white tracking-tight", children: "Hidden Videos" }),
                hiddenVideosData.totalCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ml-2 px-3 py-1 bg-red-600/80 backdrop-blur-sm text-white text-xs font-medium rounded-full", children: hiddenVideosData.totalCount })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: `w-4 h-4 transition-transform duration-300 text-gray-400 ${isDropdownExpanded ? "transform rotate-180" : ""}` })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `overflow-hidden transition-all duration-300 ${isDropdownExpanded ? "max-h-96 mt-4" : "max-h-0"}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-gray-400 mb-4 leading-relaxed font-medium", children: "Videos hidden on this page" }),
          hiddenVideosData.hiddenVideos.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-center text-gray-500 text-sm p-6 italic bg-gray-800/30 backdrop-blur-sm rounded-lg font-medium", children: "No videos hidden on this page yet" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "space-y-3 max-h-48 overflow-y-auto pr-2 custom-scrollbar", children: hiddenVideosData.hiddenVideos.map((video, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              onClick: () => handleVideoClick(video.url),
              className: `p-4 bg-gray-800/60 backdrop-blur-sm rounded-lg border-l-4 text-sm leading-relaxed transition-all duration-200 ${video.reason === "keyword" ? "border-red-500 hover:bg-gray-800/80 hover:border-red-400" : "border-red-400 hover:bg-gray-800/80 hover:border-red-300"} ${video.url ? "cursor-pointer hover:scale-[1.02] active:scale-[0.98] hover:shadow-lg hover:shadow-red-500/10" : "cursor-default"}`,
              title: video.url ? "Click to open video in new tab" : "Video URL not available",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "text-white font-semibold mb-2 line-clamp-2 flex items-start gap-3", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "flex-1", children: video.title }),
                  video.url && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "w-4 h-4 text-red-400 opacity-70 flex-shrink-0 mt-0.5" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-2 text-gray-400 font-medium", children: [
                  video.reason === "keyword" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Hash, { className: "w-3 h-3" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bot, { className: "w-3 h-3" }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-xs", children: video.reason === "keyword" ? "Hidden by keyword" : "Hidden by AI" })
                ] })
              ]
            },
            index
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "flex items-center justify-center gap-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Save, { className: "w-5 h-5" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: isSaving ? "Saving..." : "Save Settings" })
          ] })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `mt-4 p-4 bg-gray-800/60 backdrop-blur-sm text-white text-center rounded-lg text-sm font-semibold border border-gray-700 transition-all duration-300 tracking-wide ${showStatus ? "block animate-slide-in shadow-lg" : "hidden"}`, children: statusMessage }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "text-center mt-8 pt-6 border-t border-gray-800", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "text-sm text-gray-400 font-medium", children: [
          "Made with ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-red-500", children: "\u2764\uFE0F" }),
          " for a better YouTube experience"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-xs text-gray-500 mt-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", { href: "https://github.com/ayushgupta4002/ItsMyFeed", target: "_blank", rel: "noopener noreferrer", children: [
          " \u2B50 ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Star this repo" }),
          " if it helps you filter your feed!"
        ] }) })
      ] })
    ] });
  }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (container) {
      ...
      root.render(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Popup, {}));
    }
  });
